...
def training(
    ...
    background = (
        torch.ones([dataset.feature_dim], dtype=torch.float32)
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        with torch.no_grad():
            ...
            sampled_ray = (
                torch.rand(sam_masks.shape[-2], sam_masks.shape[-1]) < ray_sample_rate
            )
