...
class GaussianSplattingGUI:
    ...
    def register_dpg(self):
        ...
        with dpg.window(
            ...
            dpg.add_button(
                label="save_all_clusters",
                callback=callback_save_all_clusters,
                user_data="Some Data",
            )
            dpg.add_button(
                label="render_all_masks",
                callback=render_all_masks_callback,
                user_data="Some Data",
            )
            dpg.add_button(
    ...
    def save_all_cluster_masks(self):
        ...
        for cluster_id in range(num_clusters):
            ...
            threshold = (
                dpg.get_value("_ScoreThres")
                if dpg.does_item_exist("_ScoreThres")
                else 0.5
            )
