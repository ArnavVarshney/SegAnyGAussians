...
from diff_gaussian_rasterization_old import GaussianRasterizationSettings as GaussianRasterizationSettingsOld
from diff_gaussian_rasterization_old import GaussianRasterizer as GaussianRasterizerOld
...
def old_render(
    ...
    raster_settings = GaussianRasterizationSettingsOld(
    ...
    rasterizer = GaussianRasterizerOld(raster_settings=raster_settings)
